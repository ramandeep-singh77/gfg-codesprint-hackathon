        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Four challenging domains where your algorithmic skills can create
              real impact. Pick your battlefield.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[1, 2, 3, 4].map((_, index) => (
              ...
              >
                ...
                {/* Icon placeholder */}
                <div className="relative w-14 h-14 rounded-2xl bg-gradient-to-br from-primary/20 to-emerald-400/20 p-[1px] mb-6">
                ...
                {/* Content */}
                <h3 className="relative text-xl font-bold mb-3 text-muted-foreground">
                  Theme #{index + 1}
                </h3>
                <p className="relative text-muted-foreground/70">
                  Details coming soon. Stay tuned for exciting problem themes!
                </p>

                {/* Coming soon badge */}
                <div className="absolute top-6 right-6">
                  <span className="inline-block px-2 py-1 text-xs font-mono text-muted-foreground bg-muted rounded">
                    SOON
                  </span>
                </div>
              </div>
          ...
          {/* Commented out original themes code */}

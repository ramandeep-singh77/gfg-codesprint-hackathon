      ...
      <div className="container relative z-10 px-6 py-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 mb-8 animate-fade-in-up">
            ...
            <span className="text-sm font-medium text-primary">GFG Campus Body Presents</span>
          </div>

          {/* Main headline */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 animate-fade-in-up delay-100">
            Where <span className="text-gradient">DSA</span> Meets
            <br />
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-in-up delay-200">
            A flagship hackathon that challenges you to transform algorithmic thinking 
            into solutions that matter. Build. Learn. Innovate.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto animate-fade-in-up delay-400">
            {[
              ...
              <div key={index} className="text-center p-4 rounded-xl bg-card/50 border border-border card-hover">
